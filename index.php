            ...
            <div class="container">
                <center>
                    <div id="banner_content">
                        <h1>Shop Sphere Store</h1>
                        <br>
                        <br>
                        <button class="btn btn-default btn-lg active" data-toggle="modal" data-target="#loginmodal">Shop
                            Now</button>
                                ...
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        ...
                                        <button class="btn btn-block btn-primary" data-toggle="modal"
                                            data-target="#loginmodal">Order Now!</button>
